...
<body class="default-backgound-color">
                        ...
                        <tbody>
                            <?php foreach ($listSubtema as $index => $subtema) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <!-- TODO: change this -->
                                        <a href="<?= base_url() ?>student/scores/materi/<?= $classId ?>/<?= $subtema->id ?>" class="btn btn-primary">Lihat</a>
                                    </td>
                                </tr>
                            <?php  } ?>
                        </tbody>
    ...
    <script>
        // back
        document.getElementById("back").addEventListener("click", () => window.location.href = "<?= base_url()  ?>student/maps");
        // save
